    ...
    <div className="h-min-screen xl:py-32 py-32">
      ...
      <div className="xl:flex grid grid-cols-2 items-center justify-center gap-3 xl:gap-5 px-5">
        ...
        <div className="flex flex-col items-center justify-center mb-5">
          <div className="bg-white rounded-lg p-2 w-16 h-16 xl:h-32 xl:w-32 flex items-center justify-center mb-3">
            <Image
              src="https://wedding-invitation-ilham-kijul.s3.ap-southeast-1.amazonaws.com/hp-keep-distance.png"
              width={100}
              height={100}
              alt=""
              className=" object-contain"
          ...
          <p className="text-center">Keep distance</p>
        </div>
        <div className="flex flex-col items-center justify-center mb-5">
          <div className="bg-white rounded-lg p-2 w-16 h-16 xl:h-32 xl:w-32 flex items-center justify-center mb-3">
            <Image
        ...
        <div className="flex flex-col items-center justify-center mb-5">
          <div className="bg-white rounded-lg p-2 w-16 h-16 xl:h-32 xl:w-32 flex items-center justify-center mb-3">
            <Image
              src="https://wedding-invitation-ilham-kijul.s3.ap-southeast-1.amazonaws.com/hp-avoid.png"
              width={100}
              height={100}
              alt=""
              className=" object-contain"
          ...
          <p className="text-center">Avoid crowd</p>
        </div>
        <div className="flex flex-col items-center justify-center mb-5">
          <div className="bg-white rounded-lg p-2 w-16 h-16 xl:h-32 xl:w-32 flex items-center justify-center mb-3">
            <Image
